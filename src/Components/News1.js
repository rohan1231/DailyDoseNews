...
const News = (props)=>{
    ...
    const updateNew = async ()=> {
        ...
        // const url = `https://api.newscatcherapi.com/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=L2byAO7CcU58d7baRDGa-r4oCe_G32sc5rWc39m2lDY&page=${page}&pageSize=${props.pageSize}`;      
